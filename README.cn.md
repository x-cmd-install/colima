...
[![x-cmd/install — colima Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/colima.svg?lang=zh)](https://x-cmd.com/install/colima)
...
合计: **11,790** 行代码（覆盖前 5 种语言、共 **126** 个文件）。
...
- **Star**: 30,999 · **Fork**: 620 · **开放 issue**: 905 · **贡献者**: 111

## 累计统计

- **发布数**: 65 · **已合并 PR**: 471 · **开放 PR**: 22 · **已关闭 issue**: 533 · **开放 issue**: 372 · **提交数**: 720
...
_数据快照: `data/card/260926.yml` · 2026-09-26T05:07:15Z._
